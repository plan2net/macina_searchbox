...
class tx_macinasearchbox_pi1_wizicon {
	function proc($wizardItems)	{
		...
		$wizardItems["plugins_tx_macinasearchbox_pi1"] = array(
			"icon"=>\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath("macina_searchbox")."pi1/ce_wiz.gif",
	...
	function includeLocalLang()	{
		include(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath("macina_searchbox")."locallang.php");
		return $LOCAL_LANG;
	}
}
